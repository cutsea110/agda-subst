...
inverse x (x₁ ∷ u) v s ⟨ .x₁ ⟩⌢ .(u ⌢ v) ≌ .s with-⟦ u₂ , v₂ , P₂ , p₂ ⟧ with inverse x u v (u₂ ⌢ v₂) P₂
... | q with ⟨ x₁ ⟩⌢ u ⌢ ⟨ x ⟩ ⌢ v ≌ ⟨ x ⟩ ⌢ u₂ ⌢ ⟨ x₁ ⟩ ⌢ v₂ with-⟦ ⟨ x ⟩ ⌢ u₂ , v₂ , q , refl ⟧
inverse x (x₁ ∷ u) v .(u₂ ⌢ x₁ ∷ v₂) ⟨ .x₁ ⟩⌢ .(u ⌢ v) ≌ .(u₂ ⌢ x₁ ∷ v₂) with-⟦ u₂ , v₂ , P₂ , refl ⟧ | q | r = r
