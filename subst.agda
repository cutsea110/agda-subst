...
trans-law {xs = .(x ∷ s)} {x ∷ ys} {.(q₁ ^ x ∷ q₂)} (sbt .x s .(x ∷ ys) (⟨⟩ , .ys , p₃ , refl)) (sbt .x .ys .(q₁ ^ x ∷ q₂) (q₁ , q₂ , q₃ , refl)) = sbt x s (q₁ ^ x ∷ q₂) (q₁ , q₂ , trans-law p₃ q₃ , refl)
trans-law {xs = .(x₁ ∷ s)} {x ∷ ys} {.(q₁ ^ x ∷ q₂)} (sbt x₁ s .(x ∷ ys) (x₂ ∷ p₁ , p₂ , p₃ , p₄)) (sbt .x .ys .(q₁ ^ x ∷ q₂) (q₁ , q₂ , q₃ , refl)) = {!!}
